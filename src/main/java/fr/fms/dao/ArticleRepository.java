...
public interface ArticleRepository extends JpaRepository<Article, Long> {
    ...
    Page<Article> findByDescriptionContainsIgnoreCase(String description,
            Pageable pageable);

    Page<Article> findByCategoryIdAndDescriptionContainsIgnoreCase(Long categoryId, String description,
            Pageable pageable);
}